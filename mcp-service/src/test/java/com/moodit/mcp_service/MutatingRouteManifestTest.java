...
/**
 * Génère/valide les MANIFESTES de routes du mcp-service par INTROSPECTION SPRING (mutantes +
 * lectures GET). Voir la version core-service pour les détails du mécanisme. Ici le préfixe externe
 * est vide : les contrôleurs mcp portent déjà {@code @RequestMapping("/mcp")} et le gateway ne
 * strippe pas.
 */
