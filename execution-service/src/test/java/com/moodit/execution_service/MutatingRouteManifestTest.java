...
/**
 * Génère/valide le MANIFESTE des routes MUTANTES de l'execution-service par INTROSPECTION SPRING.
 * Voir la version core-service pour les détails. Préfixe externe vide : les contrôleurs portent
 * déjà {@code @RequestMapping("/exec")} et le gateway ne strippe pas.
 */
