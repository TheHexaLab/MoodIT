...
export const defaultLabels: AddSubscriptionPopupLabels = {
  ...
  editEstablishment: "Modifier l'établissement",
  saveEstablishment: 'Enregistrer',
  establishmentNamePlaceholder: "Nom de l'établissement",
  establishmentDomainPlaceholder: 'Domaine courriel (ex. usherbrooke.ca)',
  establishmentDomainInvalid: 'Domaine invalide (ex. usherbrooke.ca)',
  establishmentDomainTaken: 'Ce domaine courriel est déjà utilisé par un établissement.',
  deleteEstablishmentTitle: "Supprimer l'établissement",
