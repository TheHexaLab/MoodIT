...
// Icône « sparkles » (IA / MCP), 16×16, couleur via currentColor.
// Reproduit l'asset Figma (étoile à 4 branches au trait + 2 étincelles).
export function Sparkles(props: SVGProps<SVGSVGElement>): React.ReactElement {
  return (
